...
const provincesData: { code: string; name: string; bureau: string; lat: number; lng: number }[] = [
    ...
    { code: 'PTN', name: 'ปทุมธานี', bureau: 'PPH1', lat: 14.0615, lng: 100.6792 },
    ...
    { code: 'NKP', name: 'หนองคาย', bureau: 'PPH4', lat: 17.9406, lng: 102.8422 },
    ...
    { code: 'NKP', name: 'นครปฐม', bureau: 'PPH7', lat: 13.9241, lng: 100.1093 },
